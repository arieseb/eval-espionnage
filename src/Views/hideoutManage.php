    ...
    <div class="flex-around">
        <div>
            ...
            <form method="POST" action="add-hideout">
                <input type="text" name="code" id="hideout-code" placeholder="Nom de code" aria-label="Nom de code">
                <input type="text" name="type" id="hideout-type" placeholder="Type de planque" aria-label="Type de planque">
                <input type="text" name="address" id="hideout-address" placeholder="Adresse" aria-label="Adresse">
                <select name ="country_id" id="hideout-country_id" aria-label="Pays">
                    <?php
    ...
    <div class="mt-3 flex-around">
        <div>
            ...
            <form method="POST" action="update-hideout">
                <select name ="existing-hideout" id="existing-hideout" aria-label="Planque">
                    <?php
                    foreach ($hideouts->showHideouts() as $hideout) {
                        echo '<option value="'.$hideout['id'].'">'.$hideout['code'].'</option>';
                    }
