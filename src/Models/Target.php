...
class Target extends Database
{
    ...
    protected function add($codename, $firstname, $lastname, $birthdate, $country_id)
    {
        $query = '
            INSERT INTO 
                target (codename, firstname, lastname,birthdate, country_id) 
            VALUES 
    ...
    {
        $query = 'SELECT * FROM target ORDER BY codename';
        $params = [];
     ...
     * @throws QueryException
     */
    public function getTarget($id): array
    {
